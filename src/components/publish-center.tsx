...
const defaultTargets: PlatformTarget[] = [
  {
    ...
    variantBody: "Explore our latest collection with high resolution visuals and design tips. #design #launch",
    mediaRequired: true,
  },
  {
    slug: "instagram",
  ...
  },
  {
    ...
    readiness: "READY",
    statusText: "Direct Image API ready",
    variantTitle: "High-Res Visual Asset",
    variantBody: "Direct hosting CDN link generated for campaign creative.",
    mediaRequired: true,
  },
  {
    slug: "twitter",
    ...
    statusText: "Manual Assist ready · Copy ready for post composition",
    variantTitle: "Product Announcement 2026",
    variantBody: "Excited to launch our new multi-channel automation hub! 🚀 https://automation-testing-theta.vercel.app #automation",
    mediaRequired: true,
  },
  {
    slug: "postimages",
    ...
    variantTitle: "Community Visual Asset",
  ...
  },
  {
    ...
    readiness: "MANUAL_ASSIST",
    statusText: "Manual Assist ready · Assets prepared for upload",
    variantTitle: "Cloud Media CDN File",
    variantBody: "Digital asset uploaded to personal Publitio vault.",
    mediaRequired: true,
  },
  {
    slug: "wattpad",
    ...
    category: "Blog & Publishing",
    readiness: "MANUAL_ASSIST",
    statusText: "Manual Assist ready · Story title and chapter copy formatted",
    variantTitle: "Chapter 1: The Automation Era",
    variantBody: "A deep dive into next-generation digital workflow automation.",
    mediaRequired: false,
  },
  {
    slug: "behance",
    ...
    category: "Portfolio",
    readiness: "MANUAL_ASSIST",
    statusText: "Manual Assist ready · Project case study ready",
  ...
  },
  {
    slug: "pixabay",
    name: "Pixabay",
    category: "Stock Visuals",
    readiness: "MANUAL_ASSIST",
    statusText: "Manual Assist ready · Keywords and metadata pre-populated",
    variantTitle: "Creative Abstract Poster",
    variantBody: "High resolution digital background art.",
    mediaRequired: true,
  },
  {
    slug: "unsplash",
    ...
    category: "Stock Visuals",
    readiness: "MANUAL_ASSIST",
    statusText: "Manual Assist ready · Editorial tags generated",
    variantTitle: "Modern Tech Visual",
    variantBody: "Curated wallpaper visual asset.",
    mediaRequired: true,
  },
];
